...
status always says something true about who touched it last. A spec is not implementable until you
have agreed it and the status reads `approved` — the spec is the first commit on the issue's branch,
not a pull request of its own.
