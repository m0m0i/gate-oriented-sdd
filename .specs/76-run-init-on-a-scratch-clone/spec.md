...
- [ ] T1: clone, strip per clarification 1, and record what was removed and kept with the rule for each (AC1).
- [ ] T2: run `init` in the clone, steps 1–4, recording as it goes; assert AC2–AC6.
