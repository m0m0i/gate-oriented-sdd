...
**Why this cannot recur.** Two of the three claims become unable to disagree with their sources, because a validator compares them on every turn that touches source and in CI. The third cannot disagree with anything, because it no longer asserts a number **anywhere in the README** — see the amendment below. That is the distinction worth keeping: **one claim was made checkable and the other was made unnecessary**, and the second is the stronger fix wherever it is available.
