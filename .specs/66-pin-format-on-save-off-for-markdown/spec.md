...
- Acceptance criteria:
  ...
  - [x] **AC3:** every tracked file other than the new one and this spec is byte-identical to `main`, and the eight validators hold their values with `test-gates.sh` at 52 passed / 0 failed.
