...
- `evals/` is under development — authored but unrun, because `claude plugin eval` is early access. Do not wire it into CI as a passing gate until it has actually run.
