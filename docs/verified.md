...
| How did rows 1 and 2 decompose? | **two new, one new plus three re-scoped.** Row 1 (~2 issues) → #76, #77. Row 2 (~3 issues) → #78 new, and #48, #72, #47 already one-PR sized, so the work there was scoping by comment rather than splitting. Open issues 20 → 23. |
